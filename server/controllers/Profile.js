...
//             success:false,
//             message:"Something went wrong , whille update Profile"
//         });
...
// // delete account 
// // Explore - howcan we schedule this deletion 
// // crownjob
...
exports.updateProfile = async (req, res) => {
  try {
    ...
    // Update the user fields only if they are provided in the request body
