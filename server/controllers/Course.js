...
//         // fetch data
//         const { courseName, courseDescription, whatYouWillLearn, price, tag: _tag,
//             category,
//             status,
...
//         // TODO: verfiy that userID = instructorDeatails._id is same or different
...
//         return res.status(200).json({
//             success: true,
//             message: "Data for all course are fetched successfully",
//             data: allCourse
//         })
...
//         return res.status(500).json({
//             success:false,
//             message:"Someting went wrong , while fetching course details"
//         })
